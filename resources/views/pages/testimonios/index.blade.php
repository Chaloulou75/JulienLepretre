...
<div class="my-4">
	...
	<div class="w-full max-w-sm md:w-1/3 my-4 rounded overflow-hidden shadow-lg">
	  {{-- <img class="w-full" src="/img/titreprog.jpg" alt="programme"> --}}
	  <img src="{{ asset('storage/img/avatars/'.$testimonio->avatar)}}" class="fill-current object-cover w-48 h-48 rounded-full mx-auto p-2" alt="avatar">
