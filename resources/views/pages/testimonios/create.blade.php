...
<div class="max-w-sm mx-auto">
    ...
    <h1 class="my-4 text-3xl font-bold text-center uppercase text-julien-gris">
    ...
    <form class="px-8 pt-6 pb-8 mb-4 bg-gray-100 border-2 border-white rounded shadow-md animated bounceInUp"
        method="POST" enctype="multipart/form-data" action="{{ route('testimonios.store') }}">
        @csrf
        ...
        <div class="mb-4">
            ...
            <textarea id="msg" type="text"
                ...
                name="msg" value="{{ old('msg') }}" required autocomplete="msg">{{ old('msg') }}</textarea>
        ...
        <div class="mb-4">
            ...
            <input id="avatar" type="file"
                ...
                name="avatar" value="" required autocomplete="avatar">
        ...
        <div class="mb-4">
            <div class="items-center justify-between block">
                <button type="submit"
                    class="flex-auto w-full px-4 py-2 m-2 font-semibold tracking-widest text-center text-white border-2 border-white rounded bg-julien-gris hover:bg-julien-red">
                    {{ __('Enviar') }} &raquo;
                </button>
            </div>
        </div>
