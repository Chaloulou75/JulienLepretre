...
<div class="w-full mx-auto md:mx-2 text-julien-gris animated bounceInUp">
    ...
    <form class="px-8 py-2 mb-4 border-2 border-white rounded shadow-md" method="POST" enctype="multipart/form-data"
        ...
        <div class="mb-4">
            ...
            <textarea id="content" type="text" class=" @error('content') bg-red-dark @enderror" name="content"
        ...
        <div class="mb-4">
            ...
            <input id="photoPost" type="file"
                ...
                name="photoPost" value="{{ old('photoPost') }}" autocomplete="photoPost">
        ...
        <div class="mb-4">
            <label for="lienYoutube"
                class="block mb-2 text-sm font-semibold tracking-wide">{{ __('Lien Youtube du post') }}</label>
            ...
            <input id="lienYoutube" type="text" class="shadow appearance-none border rounded w-full py-2 px-3 leading-loose focus:outline-none focus:shadow-outline
             @error('lienYoutube') bg-red-dark @enderror" name="lienYoutube" value="{{ old('lienYoutube') }}"
        ...
        <div class="mb-4">
            ...
            <input id="lienInstagram" type="text" class="shadow appearance-none border rounded w-full py-2 px-3 leading-loose focus:outline-none focus:shadow-outline
             @error('lienInstagram') bg-red-dark @enderror" name="lienInstagram" value="{{ old('lienInstagram') }}"
        ...
        <div class="mb-4">
            ...
            <input id="lienFacebook" type="text" class="shadow appearance-none border rounded w-full py-2 px-3 leading-loose focus:outline-none focus:shadow-outline
             @error('lienFacebook') bg-red-dark @enderror" name="lienFacebook" value="{{ old('lienFacebook') }}"
        ...
        <div class="mb-4">
            <label for="tags"
                class="block mb-2 text-sm font-semibold tracking-wide">{{ __('Ajouter des tags au post (!! sépare chaque tag par une virgule!!)') }}</label>
