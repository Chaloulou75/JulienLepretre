...
{{-- <div class="justify-between px-8 sm:flex">
    <div class="w-full max-w-xs p-8 mx-auto my-2 border-2 border-gray-700 rounded lg:max-w-xl lg:w-1/2">
        ...
        <div class="pt-1 text-base text-center">
            <a mp-mode="dftl"
                href="https://www.mercadopago.com.ar/checkout/v1/redirect?pref_id=379948820-e9271c46-fa0b-434b-b2d7-01712dc7dfa7"
