...
<div class="w-full mb-4 py-4">
    ...
    <div class="w-full mx-auto h-auto flex flex-col-reverse md:flex-row items-start md:mb-8">
        ...
        <form class="bg-gray-100 border-2 border-white shadow-md rounded uppercase px-8 pt-6 pb-8 mb-4" method="POST" action="{{ route('contact.store') }}">
            ...
            <div class="mb-4">
                <label for="msg" class="block text-sm font-bold tracking-wide mb-2">{{ __('Molestias en tu cuerpo:') }}</label>
                    ...
                    <textarea id="msg" type="text" class="shadow appearance-none border rounded w-full py-2 px-3 h-32 md:h-40 resize leading-loose focus:outline-none focus:shadow-outline @error('msg') bg-red-dark @enderror" name="msg" value="{{ old('msg') }}" autocomplete="msg">{{ old('msg') }}</textarea>
            ...
            <div class="mb-4">
                ...
                <textarea id="problema" type="text" class="shadow appearance-none border rounded w-full py-2 px-3 h-32 md:h-40 resize leading-loose focus:outline-none focus:shadow-outline @error('problema') bg-red-dark @enderror" name="problema" value="{{ old('problema') }}" autocomplete="problema">{{ old('problema') }}</textarea>
            ...
            <div class="mb-4">
                ...
                <textarea id="alivia" type="text" class="shadow appearance-none border rounded w-full py-2 px-3 h-32 md:h-40 resize leading-loose focus:outline-none focus:shadow-outline @error('alivia') bg-red-dark @enderror" name="alivia" value="{{ old('alivia') }}" autocomplete="alivia">{{ old('alivia') }}</textarea>
            ...
            <div class="mb-4">
                ...
                <textarea id="antecedentes" type="text" class="shadow appearance-none border rounded w-full py-2 px-3 h-32 md:h-40 resize leading-loose focus:outline-none focus:shadow-outline @error('antecedentes') bg-red-dark @enderror" name="antecedentes" value="{{ old('antecedentes') }}" autocomplete="antecedentes">{{ old('antecedentes') }}</textarea>
            ...
            <div class="mb-4">
                ...
                <textarea id="objetivos" type="text" class="shadow appearance-none border rounded w-full py-2 px-3 h-32 md:h-40 resize leading-loose focus:outline-none focus:shadow-outline @error('objetivos') bg-red-dark @enderror" name="objetivos" value="{{ old('objetivos') }}" autocomplete="objetivos">{{ old('objetivos') }}</textarea>
        ...
        <div class="w-full md:w-1/3 text-center mx-auto px-2 pb-4">
