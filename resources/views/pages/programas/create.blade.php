...
<div class="w-full max-w-xs lg:max-w-xl m-auto p-auto pt-8"> 
    ...
    <form class="bg-gray-100 border-2 border-white shadow-md rounded px-8 pt-6 pb-8 mb-4" method="POST" enctype="multipart/form-data" action="{{ route('programas.store') }}">
        ...
        <div class="mb-4">
            ...
            <input id="image" type="file" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-900 leading-loose focus:outline-none focus:shadow-outline @error('image') bg-red-dark @enderror" name="image" value="" required autocomplete="image" autofocus>
        ...
        <div class="mb-4">
            ...
            <input id="image2" type="file" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-900 leading-loose focus:outline-none focus:shadow-outline @error('image2') bg-red-dark @enderror" name="image2" value="" required autocomplete="image2" autofocus>
