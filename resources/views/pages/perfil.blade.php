...
@section('content')
    ...
    <div class="w-full px-4">
        ...
        <div class="mb-4">
          <h1 class="text-gray-700 text-center text-3xl tracking-wider uppercase font-semibold">Sobre mi</h1>
        ...
        <div class="flex flex-col md:flex-row mt-2 mb-4">
            ...
            <div class="md:flex w-full md:w-3/4">
                <div class="flex-1 px-2 py-2 text-center transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
                    <i class="fas fa-hospital-alt fa-6x text-center text-gray-500 pb-2 items-center"></i>
                    <h2 class="text-lg md:text-left text-gray-600 font-semibold py-2">Primer Consultorio</h2>
                    <p class="text-gray-700 text-left text-justify">He creado mi primer consultorio en 2010 en Francia. Lo vendí en 2018 para establecerme en Buenos Aires.</p>
                </div>
                <div class="flex-1 px-2 py-2 text-center transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
                    <i class="fas fa-people-carry fa-6x text-center text-gray-500 pb-2 items-center"></i>
                    <h2 class="text-lg md:text-left text-gray-600 font-semibold py-2">Instructor en prevención</h2>
                    <p class="text-gray-700 text-left text-justify">Estuve a cargo de un programa de capacitación sobre la prevención de los riesgos relativos a las actividades físicas en empresas.</p>
                </div>
                <div class="flex-1 px-2 py-2 text-center transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
                    <i class="fab fa-instagram fa-6x text-center text-gray-500 pb-2 items-center"></i>
                    <h2 class="text-lg md:text-left text-gray-600 font-semibold py-2">Consejos de salud</h2>
                    <p class="text-gray-700 text-left text-justify">Desde mis cuentas Instagram y Facebook « Go Treat Yourself » propongo consejos y ejercicios para mejorar tu movilidad.</p>
                </div>
                <div class="flex-1 px-2 py-2 text-center transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
                    <i class="fas fa-hospital-alt fa-6x text-center text-gray-500 pb-2 items-center"></i>
                    <h2 class="text-lg md:text-left text-gray-600 font-semibold py-2">Segundo Consultorio</h2>
                    <p class="text-gray-700 text-left text-justify">Desde 2019 trabajo en mi nuevo consultorio en Buenos Aires.</p>
                </div>
