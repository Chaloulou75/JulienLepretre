<!--Hero-->
	<div class="w-full mx-auto h-screen flex flex-col {{-- md:flex-row --}} items-center px-8 bg-julien-gris">
	 {{-- bg-contain  bg-right bg-no-repeat style="background-image: url(/img/EtirementNOIRetBLANC.jpg)" --}}

		<!--Left Col-->
		<div class="flex flex-col w-full mx-auto {{-- lg:w-1/2 --}} justify-center items-center pt-2 md:px-24">
