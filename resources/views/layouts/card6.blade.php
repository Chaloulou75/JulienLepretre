<div class="w-full mx-auto max-w-sm overflow-hidden rounded border bg-white shadow">
  <div class="relative">
    ...
    <div style="background-color: rgba(0,0,0,0.6)"
      class="absolute bottom-0 mb-2 ml-3 px-2 py-1 rounded text-sm text-white">$ {{ $programme->prix6sesionesPesos }}  / {{ $programme->prix6sesionesEuros }} €</div>
  ...
  <div class="p-3">
    ...
    <div class="flex items-start justify-between">
      <p class="text-sm text-julien-gris">6 sesiones</p>
