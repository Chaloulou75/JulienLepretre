<div class="w-full flex flex-col md:flex-row text-julien-gris mx-auto rounded shadow-lg my-2">

    <div class="w-full md:w-1/3 border-t-2 border-gray-400 my-1">
       <form class="bg-gray-100 px-2 py-2" method="POST" enctype="multipart/form-data" action="{{ route('description.store', $programme->slug) }}">
        @csrf
        <div class="mb-1">
            <label for="phrase" class="block font-semibold text-center tracking-wide mb-1">{{ __('Anadir una frase') }}</label>
        ...
        <div class="text-center mb-1">
            ...
            <button type="submit" class="text-julien-gris hover:text-julien-red font-sm text-center tracking-widest flex-auto">
    ...
    <div class="w-full md:w-1/3 border-t-2 border-gray-400 my-1">
        ...
        @method('PUT')
        <div class="mb-1">
            <label for="phrase" class="block text-sm font-semibold text-center tracking-wide mb-1">{{ __('Cambiar la frase de descripcion: ')  }}</label>
    ...
    <div class="w-full md:w-1/3 border-t-2 border-gray-400 bg-gray-100 p-2 items-center justify-around my-1">

        <div class="text-center px-2 py-4">
           <a href="{{ route('programas.edit', ['slug' => $programme->slug ] ) }}">
            <button type="submit" class="text-julien-gris hover:text-julien-red font-semibold text-center tracking-widest">
