<template>
  <header class="bg-white sm:flex sm:justify-between sm:items-center sm:px-4 sm:py-2 ">
    ...
    <nav :class="isOpen ? 'block' : 'hidden'" class="px-2 pt-1 pb-2 sm:flex sm:p-0 uppercase not-italic font-bold">
      ...
      <a href="#" class="no-underline text-julien-gris animated bounceInDown hover:text-julien-red mt-1 block px-2 py-1 sm:mt-0 sm:ml-2">Testimonios</a>
      ...
      <a href="/contacto" class="no-underline text-julien-gris animated bounceInDown hover:text-julien-red mt-1 block px-2 py-1 sm:mt-0 sm:ml-2">Contacto</a>
